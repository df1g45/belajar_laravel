...
<div class="container">
    ...
    <form action="{{ route('kendaraan.update', $kendaraan->no_plat) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <div>
                ...
                <input type="radio" name="jenis_kendaraan" value="Manual Transmisi" {{ $kendaraan->jenis_kendaraan == 'Manual Transmisi' ? 'checked' : '' }} required> Manual Transmisi
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama_pemilik" id="nama_pemilik" class="form-control" value="{{ old('nama_pemilik', $kendaraan->nama_pemilik) }}" required>
        </div>
